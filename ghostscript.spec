...
Source0  : https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs10031/ghostpdl-10.03.1.tar.gz
...
%prep
%setup -q -n ghostpdl-10.03.1
cd %{_builddir}/ghostpdl-10.03.1
pushd ..
cp -a ghostpdl-10.03.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720029561
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgpcl6.so.10.03
/V3/usr/lib64/libgpdl.so.10.03
/V3/usr/lib64/libgs.so.10.03
/V3/usr/lib64/libgxps.so.10.03
/usr/lib64/libgpcl6.so.10
/usr/lib64/libgpcl6.so.10.03
/usr/lib64/libgpdl.so.10
/usr/lib64/libgpdl.so.10.03
/usr/lib64/libgs.so.10
/usr/lib64/libgs.so.10.03
/usr/lib64/libgxps.so.10
/usr/lib64/libgxps.so.10.03
