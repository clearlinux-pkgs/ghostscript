...
Source0  : https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs9533/ghostscript-9.53.3.tar.xz
...
%prep
%setup -q -n ghostscript-9.53.3
cd %{_builddir}/ghostscript-9.53.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601913682
...
cp %{_builddir}/ghostscript-9.53.3/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/e84a42ff92058462c731335c806dd2a761134b20
cp %{_builddir}/ghostscript-9.53.3/contrib/chp2200/COPYING %{buildroot}/usr/share/package-licenses/ghostscript/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/ghostscript-9.53.3/contrib/lxm3200-tweaked/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/3bfe807735331dd9d4ce59bc8efe86e2e7fe7b75
cp %{_builddir}/ghostscript-9.53.3/cups/LICENSE.txt %{buildroot}/usr/share/package-licenses/ghostscript/4f9df3f6d8b289409ab4ef55e9ca885d8ae1decd
cp %{_builddir}/ghostscript-9.53.3/doc/COPYING %{buildroot}/usr/share/package-licenses/ghostscript/78e50e186b04c8fe1defaa098f1c192181b3d837
cp %{_builddir}/ghostscript-9.53.3/freetype/docs/GPLv2.TXT %{buildroot}/usr/share/package-licenses/ghostscript/dac7127c82749e3107b53530289e1cd548860868
cp %{_builddir}/ghostscript-9.53.3/freetype/docs/LICENSE.TXT %{buildroot}/usr/share/package-licenses/ghostscript/64b7f213ddd72695d94866a1a9532ee5b3a472a8
cp %{_builddir}/ghostscript-9.53.3/jbig2dec/COPYING %{buildroot}/usr/share/package-licenses/ghostscript/78e50e186b04c8fe1defaa098f1c192181b3d837
cp %{_builddir}/ghostscript-9.53.3/jbig2dec/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/21c1d4cf3616efc56f2a970d63e9c626a2283ba6
cp %{_builddir}/ghostscript-9.53.3/lcms2mt/COPYING %{buildroot}/usr/share/package-licenses/ghostscript/1f55702d9d49a587e9d4e58c47fc82b68cccf9a2
cp %{_builddir}/ghostscript-9.53.3/lcms2mt/plugins/fast_float/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/ghostscript/1de7bacb4fbbd7b6d391a69abfe174c2509ec303
cp %{_builddir}/ghostscript-9.53.3/lcms2mt/utils/jpgicc/LICENSE_iccjpeg %{buildroot}/usr/share/package-licenses/ghostscript/46e7b80883a260d5531d06126e6bea86daccac9b
cp %{_builddir}/ghostscript-9.53.3/libpng/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/fc3951ba26fe1914759f605696a1d23e3b41766f
cp %{_builddir}/ghostscript-9.53.3/libpng/contrib/gregbook/COPYING %{buildroot}/usr/share/package-licenses/ghostscript/80b6f4fcbc19d7431482cba012e86f587828c1ba
cp %{_builddir}/ghostscript-9.53.3/libpng/contrib/gregbook/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/aa4b9207aaff26bc16c562d6cd766a9eed49af1e
cp %{_builddir}/ghostscript-9.53.3/libpng/contrib/pngminus/LICENSE.txt %{buildroot}/usr/share/package-licenses/ghostscript/29883b5b9150592328072643614229f6d320bc6e
cp %{_builddir}/ghostscript-9.53.3/openjpeg/LICENSE %{buildroot}/usr/share/package-licenses/ghostscript/a1a529b822da257f69972ea711df38489e9d4251
cp %{_builddir}/ghostscript-9.53.3/tiff/COPYRIGHT %{buildroot}/usr/share/package-licenses/ghostscript/a2f64f2a85f5fd34bda8eb713c3aad008adbb589
cp %{_builddir}/ghostscript-9.53.3/zlib/contrib/dotzlib/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/ghostscript/3f317fbb3e08fd99169d2e77105d562ea0e482c7
